...
var {CleanWebpackPlugin} = require('clean-webpack-plugin'); // 清除目录
...
module.exports = {
    ...
    plugins: [
        ...
        //     $:'jquery'
        // })
        new CleanWebpackPlugin(), // 每次打包清除output出口文件
        new CopyWebpackPlugin([  // 复制文件
            {from:'./doc', to: './'}
        ]),
        new webpack.BannerPlugin('copyright google') // 在js,css代码头部生成注释
    ],
